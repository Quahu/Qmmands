...
namespace Qmmands
{
    ...
    /// </summary>
    public sealed class CommandExecutionFailedResult : FailedResult
    {
        /// <summary>
        ///     Gets the reason of this failed result.
        /// </summary>s
        public override string FailureReason => CommandExecutionStep switch
        {
        ...
        internal CommandExecutionFailedResult(Command command, CommandExecutionStep commandExecutionStep, Exception exception)
        {
            Command = command;
